...
{
  public class CheckLeafySpiritForCorrectStrategy : IConditionStrategy
  {
    private readonly EcsWorld _game;
    public EcsPackedEntity Entity { get; set; }

    public CheckLeafySpiritForCorrectStrategy(GameWorldWrapper gameWorldWrapper)
    {
    ...
    public bool Check()
    {
      return Entity.TryUnpackEntity(_game, out EcsEntity spirit) && spirit.Has<Aimed>() && spirit.Has<Risen>();
    }
  }
}